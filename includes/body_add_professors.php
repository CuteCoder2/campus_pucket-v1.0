...
?>
								...
								<header class="panel-heading panel-heading-gray custom-tab ">
									<ul class="nav nav-tabs">
										<li class="nav-item "><a href="#student" data-bs-toggle="tab"
												class="active text-bold"><i class="fa fa-user-circle-o"></i> Teacher</a>
	...
	<div class="panel-body">
		<form action="../functions/register_professor.php" method="POST" enctype="multipart/form-data">
				...
				<div class="tab-pane" id="school"><div class="row">
						<div class="col-md-12 col-sm-12">
									<div class="row" >
										<div class="col-lg-12 ">
											<div class="form-group">
												<label for="exampleInput"><strong>Subject</strong></label>
